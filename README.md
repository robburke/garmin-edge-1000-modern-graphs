...
Built collaboratively by **Rob Burke** and Claude Code in an afternoon — the story of the build is on Rob's site: **[Man, Machine, Drawer](https://robburke.net/side-quests/man-machine-drawer/)**. From "my hand-me-down Edge 1000 is hard to read on the road" to a compiled, sideloaded, three-field graph suite. The data-visualization choices, dynamic autoscale with zone colour, the sparkline-style layout, the cadence target band, lean on Edward Tufte's principles and a bit of cycling-coaching research.
